	...
	return (
		<div className="relative pt-10 flex justify-center w-full h-max top-0">
			<div className="flex w-full xl:w-7xl items-center py-4 px-6 justify-between max-w-7xl h-max">
				<h1 className="font-bold text-2xl hoverable">LEMUELK.</h1>
				<ul className="gap-7 md:gap-12 flex items-center text-sm">
					<li className="hidden lg:block hoverable">Projects</li>
					<li className="hidden lg:block hoverable">Skills</li>
					<li className="hidden lg:block hoverable">About Me</li>
					<li className="hidden lg:block hoverable">Contact</li>
					<li>
